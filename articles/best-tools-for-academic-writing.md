...
1. **Source of Truth:** Agree on one document and platform early.
2. **Permissions:** Use tools with granular permissions (like Overleaf or Google Docs' suggestion mode).
3. **Audit Trail:** If you fear wrongful AI accusations, keep a clear revision history or screen-record your writing sessions to prove authorship.
