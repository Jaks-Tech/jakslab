...
1. **Scope Creep:** Review balloons without focus. **Fix:** Revisit your one-sentence research question.
2. **Patchwriting:** Rearranging sentences from sources. **Fix:** Write synthesis sections from memory, then check for accuracy.
3. **Source Overload:** Collecting for the sake of collecting. **Fix:** Cap initial screening and only add more if gaps remain.
