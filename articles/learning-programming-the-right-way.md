...
**The Learning Cycle:**
1. Pick one interactive resource (e.g., freeCodeCamp, Exercism).
2. Complete 2–3 lessons.
3. **Stop.** Build a tiny project using only what you just learned.
4. Return to the resource only when you are truly stuck.
