...
> **Strong:** "Refactored CI/CD pipeline; cut deployment time by 60% and reduced build failures by 15%."
...
**Example Entry:**
> **Project X (Internal Tooling):** Deprecated after 4 months. 
> **Lesson:** Learned to validate user requirements with stakeholders *before* architecture design to avoid over-engineering.
