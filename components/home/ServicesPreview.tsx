...
export default function ServicesPreview() {
  return (
    <>
      ...
      <div className="relative flex flex-col items-center text-center px-2 mb-10 sm:mb-14">
      ...
      {/* 2. SaaS Pillar Grid */}
      <div className="relative w-full max-w-[1400px] mx-auto px-0 sm:px-3">
          ...
          {services.map((s, i) => {
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative bg-white/[0.03] border border-white/10 p-6 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col transition-all duration-500 hover:bg-white/[0.07] hover:border-blue-500/30"
              >
