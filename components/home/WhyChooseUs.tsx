      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {reasons.map((r, i) => (
            <div
              key={i}
              className="group relative p-10 rounded-3xl bg-white/70 backdrop-blur border border-slate-200 shadow-sm hover:shadow-2xl hover:-translate-y-3 transition-all duration-500"
            >
              {/* Gradient Hover Glow */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-600/0 to-indigo-600/0 group-hover:from-blue-600/5 group-hover:to-indigo-600/10 transition-all duration-500 pointer-events-none" />

              {/* Icon */}
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center mb-8 group-hover:scale-110 transition duration-300">
