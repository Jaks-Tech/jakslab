  ...
  return (
    <section className="relative px-5 pb-14 pt-16 sm:px-8 sm:pb-20 sm:pt-24 lg:pt-28">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.15fr_.85fr]">
        <div>
          <p className="mb-5 text-sm tracking-wide text-slate-400">Start a project</p>
          <h1 className="max-w-3xl text-4xl font-semibold leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-6xl">Tell us what you need.</h1>
          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-400 sm:text-lg sm:leading-8">Share the brief, deadline and any useful files. We will review the request and respond with a clear scope, price and next step.</p>
        </div>
